            ...
            <div class="flex flex-wrap w-full">
                <div class="bg-white dark:bg-gray-600 w-full mx-2">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full md:flex-1">
                            <div class="font-bold p-3 w-full">Pairs with...</div>
                            <div style="max-height: 150px;" class="overflow-auto flex flex-col">
                                <label class="text-monospace text-sm inline-block pl-6 ml-1" v-for="wine in pairsWithWine">
                                    <input @change="searchQuery" v-model="search.pairs" class="align-middle ml-3" :value="wine.name" type="checkbox"> {{ wine.name }}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="w-full md:flex-1 flex-col flex">
